// Shared location dataset for Nigerian States and Local Government Areas (LGAs)
...
export const NIGERIA_LOCATIONS: Record<string, string[]> = {
  ...
  "Adamawa": [
    "Demsa", "Fufure", "Ganye", "Gayuk", "Gombi", "Girei", "Hong", "Jada", "Lamurde", 
  ...
  "Imo": [
    ...
    "Njaba", "Nkwerre", "Nwangele", "Obowo", "Oguta", "Ohaji/Egbema", "Okigwe", 
    "Orlu", "Orsu", "Oru East", "Oru West", "Owerri Municipal", "Owerri North", "Owerri South", "Unuimo"
  ],
  "Jigawa": [
    "Auyo", "Babura", "Biriniwa", "Birnin Kudu", "Buji", "Dutse", "Gagarawa", 
    "Garki", "Gumel", "Guri", "Gwaram", "Gwiwa", "Hadejia", "Jahun", "Kafur", 
    "Kaugama", "Kazaure", "Kiri Kasama", "Kiyawa", "Maigatari", "Malam Madori", 
    "Miga", "Ringim", "Roni", "Sule Tankarkar", "Taura", "Yankwashi"
  ],
  "Kaduna": [
    "Birnin Gwari", "Chikun", "Giwa", "Kajuru", "Igabi", "Ikara", "Jaba", "Jema'a", 
    "Kachia", "Kaduna North", "Kaduna South", "Kagarko", "Kaura", "Kauru", "Kubau", 
  ...
  "Kano": [
    ...
    "Kiru", "Kumbotso", "Kunchi", "Kura", "Madobi", "Minjibir", "Nasarawa", "Rano", 
  ...
  "Katsina": [
    ...
    "Mai'Adua", "Malumfashi", "Mani", "Mashi", "Musawa", "Rimi", "Sabuwa", "Safana", 
    "Sandamu", "Zango"
  ],
  "Kebbi": [
  ...
  "Ondo": [
    ...
    "Ile Oluji/Okeigbo", "Irele", "Odigbo", "Okitipupa", "Oba Ondo West", "Ondo East", 
    "Ose", "Owo"
  ],
  "Osun": [
    ...
    "Irepodun", "Irewole", "Isokan", "Iwo", "Obokun", "Odo Otin", "Ola Oluwa", 
  ...
  "Zamfara": [
    ...
    "Gusau", "Kaura Namoda", "Maradun", "Maru", "Shinkafi", "Talata Mafara", "Chafe", "Zurmi"
  ]
};
...
export const getLgasForState = (state: string): string[] => {
  if (!state) return [];
  const normalizedState = Object.keys(NIGERIA_LOCATIONS).find(
    (key) => key.toLowerCase() === state.toLowerCase()
  );
  return normalizedState ? NIGERIA_LOCATIONS[normalizedState].sort() : [];
};
