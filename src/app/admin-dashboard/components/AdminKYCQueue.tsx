...
const kycApplications: KYCApplication[] = [
  ...
  },
  {
    ...
    documents: [
      { type: "Driver's License", fileName: 'oluwaseun_license.jpg', flagged: false },
      { type: 'Proof of Address', fileName: 'oluwaseun_utility.jpg', flagged: false },
      { type: 'Selfie with ID', fileName: 'oluwaseun_selfie.jpg', flagged: false },
    ],
    status: 'Under Review',
    adminNote: '',
  },
