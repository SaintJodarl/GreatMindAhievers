...
const kycApplications: KYCApplication[] = [
  {
    ...
    state: 'Enugu',
    submitDate: 'Apr 28, 2026',
    documents: [
      { type: 'National ID (NIN)', fileName: 'amaka_nin.jpg', flagged: false },
      { type: 'Proof of Address', fileName: 'amaka_utility.jpg', flagged: false },
      { type: 'Selfie with ID', fileName: 'amaka_selfie.jpg', flagged: true },
    ],
    status: 'Under Review',
    adminNote: '',
  },
  {
    ...
    state: 'Lagos',
    submitDate: 'Apr 27, 2026',
    documents: [
      { type: "Voter's Card (PVC)", fileName: 'yetunde_pvc.jpg', flagged: false },
      { type: 'Proof of Address', fileName: 'yetunde_bank.jpg', flagged: false },
      { type: 'Selfie with ID', fileName: 'yetunde_selfie.jpg', flagged: false },
    ],
    status: 'Under Review',
    adminNote: '',
  },
  {
    ...
    email: 'chukwuemeka.i@email.com',
    state: 'Abuja',
    submitDate: 'Apr 26, 2026',
    documents: [
      { type: 'National ID (NIN)', fileName: 'chukwuemeka_nin.jpg', flagged: false },
      { type: 'Proof of Address', fileName: 'chukwuemeka_bill.jpg', flagged: true },
      { type: 'Selfie with ID', fileName: 'chukwuemeka_selfie.jpg', flagged: false },
    ],
    status: 'Under Review',
    adminNote: '',
  },
  {
    ...
    memberId: 'GMA-00534',
    name: 'Michael Umeh',
    email: 'michael.u@email.com',
    state: 'Oyo',
    submitDate: 'Apr 25, 2026',
    documents: [
      { type: "Driver's License", fileName: 'michael_license.jpg', flagged: false },
      { type: 'Proof of Address', fileName: 'michael_utility.jpg', flagged: false },
      { type: 'Selfie with ID', fileName: 'michael_selfie.jpg', flagged: false },
    ],
    status: 'Under Review',
    adminNote: '',
  },
  {
    ...
    memberId: 'GMA-00548',
    name: 'Blessing Okeke',
    email: 'blessing.okeke@email.com',
    state: 'Anambra',
    submitDate: 'Apr 24, 2026',
    documents: [
      { type: "Voter's Card (PVC)", fileName: 'blessing_pvc.jpg', flagged: true },
      { type: 'Proof of Address', fileName: 'blessing_bill.jpg', flagged: false },
      { type: 'Selfie with ID', fileName: 'blessing_selfie.jpg', flagged: false },
    ],
    status: 'Under Review',
    adminNote: '',
  },
  {
    ...
    state: 'Rivers',
    submitDate: 'Apr 23, 2026',
    documents: [
      { type: 'International Passport', fileName: 'chidi_passport.jpg', flagged: false },
      { type: 'Proof of Address', fileName: 'chidi_bank.jpg', flagged: false },
      { type: 'Selfie with ID', fileName: 'chidi_selfie.jpg', flagged: false },
    ],
    status: 'Under Review',
    adminNote: '',
  },
  {
    ...
    state: 'Imo',
    submitDate: 'Apr 22, 2026',
    documents: [
      { type: 'National ID (NIN)', fileName: 'adaeze_nin.jpg', flagged: false },
      { type: 'Proof of Address', fileName: 'adaeze_utility.jpg', flagged: false },
      { type: 'Selfie with ID', fileName: 'adaeze_selfie.jpg', flagged: false },
    ],
    status: 'Under Review',
    adminNote: '',
  },
        ...
        <div className="px-5 py-4 border-b" style={{ borderColor: 'var(--border)' }}>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              {flaggedCount > 0 && (
                <span className="badge badge-rejected text-xs">{flaggedCount} flagged</span>
              )}
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    ...
                    {hasFlagged && (
                      <span className="text-xs flex-shrink-0" style={{ color: 'var(--warning)' }}>
                        ⚠
                      </span>
                    )}
                  </div>
          ...
          >
            ...
            >
              <div>
                ...
                <p
                  className="text-xs font-mono-nums mt-0.5"
                  style={{ color: 'var(--muted-foreground)' }}
                >
                  {selectedKYC.memberId} · {selectedKYC.state} State · Submitted{' '}
                  {selectedKYC.submitDate}
                </p>
              </div>
              <button
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder={
                      decision === 'reject'
                        ? 'Explain clearly why this KYC was rejected and what the member needs to resubmit...'
                        : 'Optional note for internal records...'
                    }
                    {...register('note', {
                      validate: (val) => {
                        if (decision === 'reject' && !val?.trim())
