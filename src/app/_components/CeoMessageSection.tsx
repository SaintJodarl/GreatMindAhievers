        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="order-2 lg:order-1 space-y-8">
            <div className="mb-10 max-w-3xl sm:mb-12 mx-0 text-left">
              <span className="text-sm font-bold uppercase tracking-wider text-primary">A Message from Our CEO</span>
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-foreground sm:text-4xl md:text-5xl">Apostle Dr. Honorable Blessing Makata</h2>
              <p className="mt-4 text-base leading-relaxed text-secondary-foreground sm:text-lg">Listen to our CEO share the vision behind Great Mind Achievers, the strong community we are building together, and why every member matters in our shared journey toward growth, empowerment and collective success.</p>
            </div>
