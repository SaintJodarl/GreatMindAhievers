        ...
        {registrations.map((row) => (
          ...
          >
            <div className="flex items-start justify-between gap-3">
              ...
              >
                {row.placementPosition === 'LEFT' ? 'Left' : 'Right'}
              </span>
            </div>

            <div className="mt-3 grid grid-cols-2 gap-2 text-xs">
              <div className="rounded-md bg-gray-50 p-2">
                <p className="font-semibold text-gray-400">Code</p>
                <p className="mt-0.5 break-all font-mono font-bold text-indigo-650">
                  {row.codeUsed}
                </p>
              </div>
              <div className="rounded-md bg-gray-50 p-2">
                ...
                <p className="mt-0.5 font-medium text-gray-700">
                  {formatRegistrationDate(row.registrationDate)}
                </p>
              </div>
            </div>
          </article>
