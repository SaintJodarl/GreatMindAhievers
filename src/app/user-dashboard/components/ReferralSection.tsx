  ...
  return (
    <div className="space-y-5">
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(135deg, rgba(108,71,255,0.12) 0%, rgba(16,217,160,0.06) 100%)',
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={handleCopy} className="btn-primary px-3 py-2 text-xs flex-shrink-0">
              {copied ? (
                <>
        ...
        >
          {[
            ...
            <div key={`refstat-${stat?.label}`} className="text-center">
              <p className="text-xl font-bold font-mono-nums" style={{ color: stat?.color }}>
                {stat?.value}
              </p>
            ...
            <tbody>
              {referrals?.map((r, i) => (
                ...
                >
                  ...
                  <td
                    className="px-4 py-3 text-xs font-mono-nums font-bold"
                    style={{
                      color: r?.commission > 0 ? 'var(--accent)' : 'var(--muted-foreground)',
                    }}
                  >
                  ...
                  <td className="px-4 py-3">
                    <span
                      className={`badge ${r?.status === 'Active' ? 'badge-active' : 'badge-pending'}`}
                    >
                      {r?.status}
                    </span>
                  </td>
